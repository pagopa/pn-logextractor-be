...
public class ResponseConstants {
	...
	public static final String NO_NOTIFICATION_FOUND = "Nessuna notifica trovata per i dati inseriti";
	public static final String NO_DOCUMENT_FOUND = "Nessun documento trovato per i dati inseriti";
