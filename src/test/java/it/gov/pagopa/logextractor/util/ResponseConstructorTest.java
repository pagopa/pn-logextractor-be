...
class ResponseConstructorTest {
  ...
  void testCreateNotificationLogResponse_whenAllFilesAreProvided_returnsCreatedZipArchive()
      throws IOException {
    ...
    File logFile = fileUtilities.writeTxt(openSearchLogs, GenericConstants.LOG_FILE_NAME);
