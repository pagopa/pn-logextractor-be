...
//    void testGetMonthlyNotifications_whenProvidedDataIsValid_returnsZipArchive() throws IOException, LogExtractorException, CsvRequiredFieldEmptyException, CsvDataTypeMismatchException, ParseException {
//        MonthlyNotificationsRequestDto dto = new MonthlyNotificationsRequestDto();
//        dto.setEndMonth(OffsetDateTime.now());
//        dto.setReferenceMonth(OffsetDateTime.now());
//        dto.setPublicAuthorityName("Comune di Milano");
...
//        ArrayList<NotificationData> notificationDataArrayList = new ArrayList<>(List.of(notificationData));
//        zipArchiveResponse.setZip(zipArchive);
//        Mockito.when(deanonimizationApiHandler.getPublicAuthorityId(Mockito.any())).thenReturn("test");
//        Mockito.when(notificationApiHandler.getNotificationsByMonthsPeriod(Mockito.any(), Mockito.any(), Mockito.any()))
...
//                .thenReturn(zipArchiveResponse);
//        DownloadArchiveResponseDto response = (DownloadArchiveResponseDto)service.getMonthlyNotifications(dto,
//                "test", "test");
//        assertEquals(zipArchive, response.getZip());
//    }
//
...
//        dto.setDateTo(LocalDate.now());
//        dto.setTraceId("123");
//        Mockito.when(openSearchApiHandler.getAnonymizedLogsByTraceId(Mockito.anyString(), Mockito.any(), Mockito.any()))
//                .thenReturn(List.of());
...
//    void testGetTraceIdLogs_whenProvidedDataIsValid_returnsZipArchive() throws IOException, LogExtractorException {
//        TraceIdLogsRequestDto dto = new TraceIdLogsRequestDto();
//        dto.setDateFrom(LocalDate.now());
//        dto.setDateTo(LocalDate.now());
//        dto.setTraceId("123");
...
//
//        Mockito.when(notificationApiHandler.getNotificationDetails(Mockito.anyString())).thenReturn(notificationDetails);
//        Mockito.when(notificationApiHandler.getNotificationHistory(Mockito.any(), Mockito.anyInt(), Mockito.any()))
...
//                .thenReturn(downloadFileDataArrayList);
//        Mockito.when(notificationApiHandler.getDownloadMetadata(Mockito.any())).thenReturn(fileDownloadMetadataResponseDto);
//
...
//                .thenReturn(new File("test"));
//        Mockito.when(responseConstructor.createNotificationLogResponse(Mockito.any(), Mockito.any(), Mockito.any()))
//                .thenReturn(zipArchiveResponse);
//        DownloadArchiveResponseDto response = (DownloadArchiveResponseDto)service.getNotificationInfoLogs(dto,
//                "test", "test");
//        assertEquals(zipArchive, response.getZip());
//    }
//
...
//    void testGetDeanonymizedPersonLogs_whenProvidedDataIsValid_returnsEmptyResponse() throws IOException, LogExtractorException {
//        PersonLogsRequestDto dto = new PersonLogsRequestDto();
//        dto.setTicketNumber("inc123");
//        dto.setDateFrom(LocalDate.now());
//        dto.setDateTo(LocalDate.now());
...
//    void testGetDeanonymizedPersonLogs_whenProvidedDataIsValid_returnsZipArchiveWithUidLogs() throws IOException, LogExtractorException {
//        PersonLogsRequestDto dto = new PersonLogsRequestDto();
//        dto.setTicketNumber("inc123");
//        dto.setDateFrom(LocalDate.now());
//        dto.setDateTo(LocalDate.now());
...
//        Mockito.when(responseConstructor.createNotificationLogResponse(Mockito.any(), Mockito.any(), Mockito.any()))
//                .thenReturn(zipArchiveResponse);
//        DownloadArchiveResponseDto response = (DownloadArchiveResponseDto)service.getDeanonimizedPersonLogs(dto,
//                "test", "test");
//        assertEquals(zipArchive, response.getZip());
//    }
//
...
//    void testGetDeanonymizedPersonLogs_whenProvidedDataIsValid_returnsZipArchiveWithIunLogs() throws IOException, LogExtractorException {
//        NotificationDetailsResponseDto notificationDetails = new NotificationDetailsResponseDto();
//        notificationDetails.setDocuments(new ArrayList<>());
//        notificationDetails.setRecipients(new ArrayList<>());
//        notificationDetails.setSentAt(OffsetDateTime.now().toString());
...
//        zipArchiveResponse.setZip(zipArchive);
//        Mockito.when(openSearchApiHandler.getAnonymizedSessionLogsByJti(Mockito.anyString(), Mockito.any(), Mockito.any()))
//                .thenReturn(List.of("{\"@timestamp\":\"2023-01-10T12:10:15.300Z\"}"));
//        Mockito.when(responseConstructor.createSimpleLogResponse(Mockito.any(), Mockito.any(), Mockito.any()))
//                .thenReturn(zipArchiveResponse);
//        DownloadArchiveResponseDto response = (DownloadArchiveResponseDto)service.getAnonymizedSessionLogs(dto,
//                "test", "test");
//        assertEquals(zipArchive, response.getZip());
//    }
//
...
//    void testGetDeanonimizedSessionLogs_whenProvidedDataIsValid_returnsZipArchive() throws IOException, LogExtractorException {
//        SessionLogsRequestDto dto = new SessionLogsRequestDto();
//        dto.setDateFrom(LocalDate.now());
//        dto.setDateTo(LocalDate.now());
...
//                .thenReturn(zipArchiveResponse);
//
//        DownloadArchiveResponseDto response = (DownloadArchiveResponseDto)service.getDeanonimizedSessionLogs(dto,
//                "test", "test");
//        assertEquals(zipArchive, response.getZip());
//    }
//
